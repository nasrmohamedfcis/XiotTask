package com.example.nasrmohamed.xiottask.Services;
...
public class MqttMessageService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "onCreate");
        mqttConnection = new MqttConnection(getApplicationContext());
        userData = new UserData(this);
        mqttAndroidClient = mqttConnection.getMqttClient(userData.getServerUrl(),userData.getClientID());
